                ...
                <div class="max-w-4xl bg-white p-8 shadow-lg rounded-lg">
                    ...
                    <form action="{{ route('addDoctor') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                <label for="doctor_id" class="block text-gray-700 text-sm font-bold mb-2">Doctor ID:</label>
                                <input type="text" name="doctor_id" id="doctor_id"
                                    value="{{ isset($doctor) ? $doctor->doctor_id : old('doctor_id') }}"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    placeholder="Enter doctor's doctor id" required>
                            </div>
