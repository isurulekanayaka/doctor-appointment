<nav class="flex items-center justify-center w-screen h-20 font-serif bg-slate-100">
    <div class="w-[1275px] flex justify-between px-5 md:px-0 py-6 ">
        <div class="flex items-center w-full">
            <a class="text-3xl font-bold text-green-500" href="{{ route('userhome.index') }}">
        ...
        <div class="flex gap-5 mr-8 md:mr-1 items-center">
            <div class="z-10">
                <img src="{{ asset('icon/profile-user.png') }}" class="w-12 h-auto cursor-pointer" alt="Specialization Icon"
                    onclick="openprofile()">
                <div id="profile-menu" class="fixed flex flex-col hidden bg-white border mt-2 z-0">
                    <a class="flex w-full h-8 px-4 hover:text-blue-700 hover:bg-slate-100" href="#">Name</a>
                    <a class="flex w-full h-8 px-4 hover:text-blue-700 hover:bg-slate-100" href="{{route('user.profile')}}">Update Profile</a>
                    <a class="flex w-full h-8 px-4 hover:text-blue-700 hover:bg-slate-100" href="#">View Profile</a>
                    <a class="flex w-full h-8 px-4 hover:text-blue-700 hover:bg-slate-100" href="#">Log Out</a>
                </div>
            </div>
            <div class="relative group">
                <a class="flex items-center justify-center px-5 text-center text-white bg-blue-500 border border-blue-500 w-28 rounded-xl group-hover:text-blue-500 group-hover:bg-white"
                    ...
                    Login
                    <svg class="hidden w-4 h-4 ml-2 group-hover:block" xmlns="http://www.w3.org/2000/svg" fill="none"
...
<div id="responsive-menu" class="fixed flex flex-col hidden bg-white border right-5 xl:hidden">
    ...
    <a class="flex w-full h-8 px-4 hover:text-blue-700 hover:bg-slate-100"
        href="{{ route('userchannel.index') }}">Doctor Channel</a>
    <a class="flex w-full h-8 px-4 hover:text-blue-700 hover:bg-slate-100"
        href="{{ route('userfirstaid.index') }}">First Aid</a>
    <a class="flex w-full h-8 px-4 hover:text-blue-700 hover:bg-slate-100" href="{{ route('userfqa') }}">FQA</a>
    <a class="flex w-full h-8 px-4 hover:text-blue-700 hover:bg-slate-100"
        href="{{ route('usercontact.index') }}">Category</a>
</div>
<div id="profile-menu" class="fixed flex flex-col hidden bg-white border">
    <a class="flex w-full h-8 px-4 hover:text-blue-700 hover:bg-slate-100" href="#">Profile</a>
