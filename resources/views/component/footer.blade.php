...
<footer class="flex items-center justify-center w-screen bg-blue-500">
    <div class="w-[1275px]">
        <div class="justify-between gap-24 px-5 py-6 md:px-0 md:flex ">
            ...
            <div class="w-1/5">
                ...
                <div class="gap-3 social-icons md:flex md:flex-col">
                    <a href="https://facebook.com" class="text-slate-300 hover:text-white"><i class="fab fa-facebook-f"></i></a>
                    <a href="https://twitter.com" class="text-slate-300 hover:text-white"><i class="fab fa-twitter"></i></a>
                    <a href="https://instagram.com" class="text-slate-300 hover:text-white"><i class="fab fa-instagram"></i></a>
                    <a href="https://linkedin.com" class="text-slate-300 hover:text-white"><i class="fab fa-linkedin-in"></i></a>
                </div>
            </div>
        </div>
        <div>
