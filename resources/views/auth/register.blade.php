...
<body class="font-serif">
    ...
    @section('content')
        <div class="flex items-center justify-center  md:my-0 ">
            <div
                class="flex flex-col md:flex-row items-center justify-center w-full max-w-screen-xl gap-4 bg-white rounded-lg shadow-xl p-4 md:p-8">
                <!-- Registration Form -->
                <div class="md:w-2/5 bg-white p-8 rounded shadow-md border items-center justify-center w-screen">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="flex justify-center text-sm">
                            <a href="{{ route('user.login') }}" class="text-blue-500 hover:text-blue-700">Already have an
                                account? Sign In</a>
                        </div>
                    </form>
                </div>
                ...
                <div class="md:w-3/5">
                    ...
                    <img src="{{ asset('images/login2.jpg') }}" alt="Login Image"
