                        ...
                        <div
                            ...
                            <form action="" class="space-y-4 w-full flex flex-col mb-10">
                                ...
                                <div class="flex items-center space-x-2 border-b border-blue-500 py-2 px-4 rounded-md">
                                    ...
                                    <select
                                        class="border-none p-3 rounded-md w-full text-xl bg-transparent outline-none">
                                        <option value="" disabled selected class="">Any Specialization</option>
                                ...
                                <div class="flex items-center space-x-2 text-center justify-center">
                                    <!-- Heroicons icon for date input -->
                                    <button class="mt-5 bg-blue-500 px-16 text-white font-bold border border-blue-500 hover:bg-transparent hover:text-blue-500 text-xl py-3 rounded-lg">Search</button>
                                </div>
                            </form>
                    ...
                    <div class="text-center">
                        ...
                        <div class="mt-10 flex w-full gap-4">
                            ...
                            <div class="w-1/4 border p-4 text-center bg-orange-100 rounded-md border-orange-600">
                                ...
                                <svg class="mx-auto mb-4 w-8 h-8 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12H9m0 0H3m6 0v6m6-6v6m6-6v6m-6-6v6m-6-6v6m0 0h6m6 0h6m-6-6V6m-6 6V6M9 6H3m6 0h6" />
                                </svg>
                            ...
                            <div class="w-1/4 border p-4 text-center bg-yellow-100 rounded-md border-yellow-600">
                                ...
                                <svg class="mx-auto mb-4 w-8 h-8 text-yellow-500" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
